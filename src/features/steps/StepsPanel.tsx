...
const StepsPanel = () => {
  ...
  return (
    <section className="relative grid h-[98px] w-full place-items-center before:absolute before:left-0 before:top-0 before:h-[172px] before:w-full before:bg-panel-mobile before:bg-cover before:bg-[center_top] before:bg-no-repeat before:content-[''] md:min-h-[570px] md:min-w-[275px] md:place-items-start md:px-[34px] md:py-10 md:before:h-full md:before:w-full before:md:rounded-[10px] md:before:bg-panel-desktop">
