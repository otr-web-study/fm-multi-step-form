export const ConfirmedPanel = () => {
  return (
    <div className="mx-[max(16px,4vw)] flex flex-col items-center rounded-lg bg-white px-6 py-20 shadow-base-sh md:ml-[min(98px,7vw)] md:mr-[min(94px,7vw)] md:h-full md:justify-center md:px-0 md:shadow-none">
      <img
