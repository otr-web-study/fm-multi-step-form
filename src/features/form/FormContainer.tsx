...
export const FormContainer: FC<FormContainerProps> = ({
  ...
  const nextBtnClassName = clsx(
    'col-start-2 justify-self-end rounded-[4px] md:rounded-[8px] px-4 py-[10px] text-sm text-white transition-colors duration-500 md:py-[14px] md:px-[26px] md:text-base',
    {
  ...
  return (
    ...
    >
      <div className="mx-[max(16px,6vw)] rounded-lg bg-white px-6 py-[30px] text-marine-blue shadow-base-sh md:mx-0 md:px-0 md:py-[42px] md:shadow-none">
      ...
      <div className="grid min-h-[76px] grid-cols-2 items-center bg-white px-[max(16px,6vw)] shadow-base-sh md:min-h-[82px] md:px-0 md:shadow-none">
        {hasPrevStep && (
          <button
            className="justify-self-start text-cool-gray transition-colors hover:text-purplish-blue/60"
