...
export const PlanCard: FC<PlanCardProps> = forwardRef<HTMLDivElement, PlanCardProps>(
  ({ title, icon, price, bonus, planType, isActive, onClick }, ref) => {
    ...
    return (
      <motion.div ref={ref} layout className={className} onClick={onClick}>
